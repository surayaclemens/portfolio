  ...
  return (
    <main className='morphology'>
      <ProjectTemplate 
        ...
        overviewDetails={<p className='section__details'>Morphology is a gamified learning platform for heritage languages. My ultimate passion project, the app and its marketing site are 100% designed and developed by me. This is a work in progress, MVP app coming soon!</p>}
        roleDetails={
      ...
      <ul className='section__list'>
        ...
        moreDetails={
          <p className='section__details'>This project is a work in progress. Check back for development updates!</p>
        }
        moreImages={
          <div className='carousel'>
